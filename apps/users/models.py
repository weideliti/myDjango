...
class UserProfile(AbstractUser):
    ...
    image = models.ImageField(upload_to="image/%Y/%m", default=u"image/default.pug", max_length=100)
...
class Banner(models.Model):
    ...
    image = models.ImageField(upload_to="banner/%Y/%m", verbose_name=u"轮播图",null=True, blank=True)
